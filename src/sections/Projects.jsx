    ...
    function handleNavigation(direction) {
        setSelectedProjectIndex((prev) => {
            if (direction == "previous") {
                return prev == 0 ? projectsLength - 1 : prev - 1;
            }else {
                return prev == projectsLength - 1 ? 0 : prev + 1 ;
            }
        })
    }
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 gap-5 w-full">
                <div className="flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-300">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-5">
                        ...
                        <a href={currentProject?.href} target="_blank" rel="noreferror" className="flex items-center gap-2 cursor-pointer text-white-600">
                            <p className="text-white">check live status</p>
